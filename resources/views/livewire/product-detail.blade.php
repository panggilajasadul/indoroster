                    ...
                    <div class="p-3.5 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                        ...
                        @else
                            <div class="flex items-center">
                                <button type="button" wire:click="requestQuotation" wire:loading.attr="disabled" wire:target="requestQuotation" class="px-6 h-10 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl shadow-md shadow-emerald-600/20 transition-all flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    </svg>
                                    <span wire:loading.remove wire:target="requestQuotation">📄 Minta Penawaran Resmi (RFQ)</span>
                                    <span wire:loading wire:target="requestQuotation">Mengarahkan ke Form Penawaran...</span>
                                </button>
                            </div>
                        @endif
                    </div>
