...
<div class="min-h-screen bg-slate-50 dark:bg-slate-950 py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div class="relative rounded-3xl overflow-hidden bg-gradient-to-br from-white via-slate-50 to-emerald-50/20 dark:from-slate-900 dark:via-slate-850 dark:to-slate-900 border border-slate-200/80 dark:border-slate-800 text-slate-900 dark:text-white p-8 sm:p-12 lg:p-16 shadow-soft-xl dark:shadow-2xl">
            ...
            <div class="relative z-10 max-w-3xl">
                ...
                <h1 class="text-3xl sm:text-5xl font-black tracking-tight leading-tight text-slate-900 dark:text-white mb-6">
                    {!! !empty($page?->title) && $page->title !== 'Distributor & Grosir Pabrik (Khusus Toko Bangunan & Agen Material)' ? e($page->title) : 'Supplier Roster Beton & <span class="text-terra-500">Grosir Pabrik Resmi</span>' !!}
                </h1>
                <p class="text-base sm:text-lg text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
                    {{ $page?->meta_description ?: 'Dapatkan margin keuntungan maksimal untuk toko bangunan, depo material, dan distributor daerah dengan skema harga per truk (ritase) paling kompetitif langsung dari pusat produksi.' }}
                </p>
