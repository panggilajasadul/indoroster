@push('seo')
<x-ecommerce-itemlist-schema name="Pricelist & Katalog Roster Beton Grosir Toko Bangunan" description="Katalog harga grosir pabrik roster beton per ritase truk untuk mitra depo material dan toko bangunan." :products="$products" />
@endpush
...
<div class="min-h-screen bg-slate-50 dark:bg-slate-950 py-10">
        ...
        <div class="relative rounded-3xl overflow-hidden bg-gradient-to-br from-white via-slate-50 to-emerald-50/20 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 border border-slate-200/80 dark:border-slate-800 text-slate-900 dark:text-white p-8 sm:p-12 lg:p-16 shadow-soft-xl dark:shadow-2xl">
            ...
            <div class="relative z-10 max-w-3xl">
                ...
                <h1 class="text-3xl sm:text-5xl font-black tracking-tight leading-tight text-slate-900 dark:text-white mb-6">
                    Supplier Roster Beton & <span class="text-terra-500">Grosir Pabrik Resmi</span>
                </h1>
                <p class="text-base sm:text-lg text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
                    Dapatkan margin keuntungan maksimal untuk toko bangunan, depo material, dan distributor daerah dengan skema harga per truk (ritase) paling kompetitif langsung dari pusat produksi.
                </p>
                <div class="flex flex-wrap items-center gap-4">
                    <a href="{{ $waUrl }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm sm:text-base shadow-lg shadow-emerald-600/25 transition-all hover:scale-[1.02]">
                        ...
                        Hubungi Tim Grosir Pabrik (WhatsApp)
                    </a>
                    <a href="{{ route('catalog') }}" class="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-white hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-bold text-sm transition-all border border-slate-300 dark:border-slate-700 shadow-xs">
                        Katalog Produk Lengkap &rarr;
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                ...
                <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-2">Harga Pabrik Langsung</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Langsung dari pusat produksi. Anda mendapatkan harga terendah dari pabrik sehingga toko atau depo material Anda dapat menjual kembali dengan margin profit yang sangat sehat.
                </p>
            </div>
            <div class="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                <div class="text-3xl mb-4">🚛</div>
                <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-2">Skema Pengiriman Per Truk (Ritase)</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Armada truk siap antar hingga depan toko Anda di area Jabodetabek, Bandung, Karawang, Cirebon, dan seluruh Jawa Barat dengan garansi pecah 100%.
                </p>
            </div>
            <div class="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                <div class="text-3xl mb-4">🔄</div>
                <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-2">Perputaran Stok Cepat & Varian Lengkap</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Motif-motif paling laris selalu ready stock di pabrik kami, siap re-stock cepat kapan pun inventori toko material Anda menipis.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 pb-4 border-b border-slate-200 dark:border-slate-800">
            <div>
                <h2 class="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                    Katalog Produk Grosir Toko Bangunan
                </h2>
                <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
                    Koleksi motif roster beton & bata expose paling laris di pasaran ritel toko bangunan.
                </p>
            </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            @php
                ...
                $itemWaUrl = "https://wa.me/{$waNumber}?text=" . urlencode("Halo Tim Grosir IndoRoster, saya dari Toko Bangunan ingin menanyakan harga grosir per ritase untuk motif: {$product->name}.");
            @endphp
                    ...
                    <div class="mt-3 pt-2.5 border-t border-slate-100 dark:border-slate-800">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <a href="{{ $itemWaUrl }}" target="_blank" rel="noopener noreferrer" class="py-2 px-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold flex items-center justify-center gap-1 shadow-sm transition hover:scale-[1.02]">
                                ...
                                <span>{{ \App\Models\SiteSetting::showPrices() ? 'Pesan WA' : 'Minta Penawaran' }}</span>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <x-b2b-scale-section segment="supplier" highlight-scale="partai-besar" />
        <x-b2b-city-links title="Rute Distribusi Grosir Depo Material & Toko Bangunan" :cities="['purwakarta', 'subang', 'karawang', 'cirebon', 'cianjur', 'indramayu']" />
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="rounded-3xl bg-terra-500 text-white p-8 sm:p-12 text-center relative overflow-hidden shadow-xl shadow-terra-500/20">
            <div class="relative z-10 max-w-2xl mx-auto">
                <h2 class="text-2xl sm:text-4xl font-extrabold mb-4">Pricelist Grosir Pabrik & Kemitraan Toko Bangunan</h2>
                <p class="text-terra-100 text-sm sm:text-base mb-8">
                    Dapatkan katalog lengkap harga grosir per ritase truk dengan margin keuntungan maksimal untuk depo material Anda.
                </p>
                <a href="{{ $waUrl }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2.5 px-8 py-4 rounded-xl bg-slate-900 hover:bg-slate-850 text-white font-bold text-base shadow-2xl transition hover:scale-105">
                    <span>💬</span> Hubungi Sales Grosir via WhatsApp
                </a>
            </div>
        </div>
    </div>
