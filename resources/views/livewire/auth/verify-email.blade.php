    ...
    <div class="max-w-md w-full space-y-6 bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
        ...
        <div class="flex items-center justify-center gap-2 mb-2">
            <div class="flex items-center gap-1.5">
                ...
                <span class="text-xs font-semibold text-terra-600 hidden sm:inline">Daftar</span>
            </div>
            ...
            <div class="flex items-center gap-1.5">
                ...
                <span class="text-xs font-semibold text-terra-600 hidden sm:inline">Verifikasi</span>
            </div>
            ...
            <div class="flex items-center gap-1.5">
                ...
                <span class="text-xs font-medium text-slate-400 hidden sm:inline">Selesai</span>
            </div>
        </div>

        <div class="text-center">
            <div class="mx-auto w-16 h-16 bg-terra-50 rounded-full flex items-center justify-center mb-6">
                <svg class="w-8 h-8 text-terra-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="mt-1 text-sm font-bold text-terra-600 bg-terra-50 px-4 py-2 rounded-lg inline-block">
                {{ auth()->user()->email }}
            </p>
        ...
        <div class="space-y-3">
            <button wire:click="resend" wire:loading.attr="disabled" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-semibold text-white bg-terra-600 hover:bg-terra-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-terra-500 transition-colors disabled:opacity-75 disabled:cursor-not-allowed">
            ...
            <a href="{{ route('logout') }}" class="w-full flex justify-center py-3 px-4 border border-slate-200 rounded-xl shadow-sm text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-200 transition-colors">
                Keluar
            </a>
        </div>
    </div>
