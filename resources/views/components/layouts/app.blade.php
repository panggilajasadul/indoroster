                    ...
                    <div x-show="mobileMenuOpen" 
                        ...
                        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-2xl">
                            ...
                            <div class="mt-auto border-t border-slate-100 px-6 py-6 bg-slate-50">
                                ...
                                <a href="https://wa.me/{{ $waNumber }}" target="_blank" class="flex items-center gap-3 text-sm font-medium text-slate-700 hover:text-green-600 mb-4 transition-colors">
    ...
    <main class="flex-grow pb-24 lg:pb-0 relative">
        ...
        @if (session()->has('success') || session()->has('error'))
            <div x-data="{ show: true }" x-show="show" x-transition class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
                <div class="p-4 rounded-xl border flex items-center justify-between {{ session()->has('success') ? 'bg-green-50 border-green-200 text-green-800' : 'bg-red-50 border-red-200 text-red-800' }}">
                    <div class="flex items-center gap-3">
                    ...
                    <button @click="show = false" class="p-1 rounded-lg hover:bg-black/5 text-slate-400 hover:text-slate-600 transition">
