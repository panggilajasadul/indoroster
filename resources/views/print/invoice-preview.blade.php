...
<head>
    <meta charset="UTF-8">
    <style>
        .preview-box { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; color: #333; line-height: 1.5; padding: 20px; background: white; border-radius: 8px; overflow-y: auto; max-height: 70vh; }
        ...
        table.totals tr.bold td { font-weight: bold; font-size: 16px; border-top: 2px solid #cbd5e0; color: #c2410c; }
                ...
                <tr>
                    <td>
                        ...
                        @if($item->product_variant_name && $item->product_variant_name !== '-')
                            <small style="color: #718096;">Varian: {{ $item->product_variant_name }}</small><br>
                        @endif
