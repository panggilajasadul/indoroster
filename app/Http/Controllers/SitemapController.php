...
class SitemapController extends Controller
{
    ...
    public static function generate(?string $customBaseUrl = null): void
    {
        ...
        $staticPages = [
            ...
            ['url' => '/kebijakan-garansi-pengembalian', 'priority' => 0.5, 'freq' => Url::CHANGE_FREQUENCY_MONTHLY],
            ['url' => '/kebijakan-pengiriman', 'priority' => 0.5, 'freq' => Url::CHANGE_FREQUENCY_MONTHLY],
