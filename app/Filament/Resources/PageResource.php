                ...
                ->schema([
                    Forms\Components\Builder::make('content')
                        ...
                        ->blocks([
                            ...
                            Forms\Components\Builder\Block::make('b2b_contractor_hub')
                                ->label('[7. B2B & Fitur] 🏗️ Hub Kontraktor & Pemborong (Lengkap Produk & Permintaan RAB)')
                                ->icon('heroicon-o-wrench-screwdriver')
                                ->schema([
                                    Forms\Components\Placeholder::make('info')
                                        ->content('Seksi interaktif lengkap untuk rekan Kontraktor & Pemborong: Banner Penawaran RAB, 3 Pilar Keunggulan Proyek, dan Live Filter Katalog Produk khusus pengadaan.'),
                                ]),

                            Forms\Components\Builder\Block::make('b2b_developer_hub')
                                ->label('[7. B2B & Fitur] 🏘️ Hub Developer & Klaster Perumahan')
                                ->icon('heroicon-o-home-modern')
                                ->schema([
                                    Forms\Components\Placeholder::make('info')
                                        ->content('Seksi pengadaan skala cluster / kawasan: Penawaran kontrak suplai seragam, jaminan volume ribuan pcs, dan katalog produk.'),
                                ]),

                            Forms\Components\Builder\Block::make('b2b_architect_hub')
                                ->label('[7. B2B & Fitur] 📐 Hub Arsitek & Desainer (Katalog Teknis & Spesifikasi)')
                                ->icon('heroicon-o-pencil-square')
                                ->schema([
                                    Forms\Components\Placeholder::make('info')
                                        ->content('Seksi arsitektural lengkap: Permintaan sampel fisik material, data spesifikasi dimensi/ventilasi, dan eksplorasi katalog.'),
                                ]),

                            Forms\Components\Builder\Block::make('b2b_supplier_hub')
                                ->label('[7. B2B & Fitur] 🏪 Hub Grosir Pabrik & Toko Bangunan (Suplier Ritel)')
                                ->icon('heroicon-o-building-storefront')
                                ->schema([
                                    Forms\Components\Placeholder::make('info')
                                        ->content('Seksi program keagenan toko material: Skema harga grosir per truk/ritase, garansi bebas retur pecah, dan katalog toko.'),
                                ]),

                            Forms\Components\Builder\Block::make('b2b_project_hub')
                                ->label('[7. B2B & Fitur] 🏢 Hub Pengadaan Proyek Komersial, Cafe, & Fasad Gedung')
                                ->icon('heroicon-o-building-office-2')
                                ->schema([
                                    Forms\Components\Placeholder::make('info')
                                        ->content('Seksi fasad arsitektural proyek gedung: Hotel, cafe resto, villa resort, dan ruko dengan live katalog filter.'),
                                ]),

                            Forms\Components\Builder\Block::make('roster_calculator')
                                ->label('[7. B2B & Fitur] 🧮 Kalkulator Dinding Roster Interaktif (Hitung Kebutuhan + WA)')
                                ->icon('heroicon-o-calculator')
                                ->schema([
                                    Forms\Components\Placeholder::make('info')
                                        ->content('Alat kalkulator interaktif Livewire: Menghitung kebutuhan luas m2, total keping (pcs), safety waste 5%, estimasi bobot kg, dan tombol otomatis pesan WhatsApp.'),
                                ]),

                            Forms\Components\Builder\Block::make('location_directory')
                                ->label('[7. B2B & Fitur] 📍 Direktori Wilayah & Layanan Pengiriman Seluruh Indonesia')
                                ->icon('heroicon-o-map-pin')
                                ->schema([
                                    Forms\Components\Placeholder::make('info')
                                        ->content('Daftar kota & jangkauan distribusi nasional otomatis dari database SEO Lokasi (Jabodetabek, Bandung, Jabar, dan nasional).'),
                                ]),
                        ])
                        ->columnSpanFull()
                        ->collapsed(),
