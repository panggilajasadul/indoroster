    ...
    public function render()
    {
        return view('livewire.production-process')
            ->layout('components.layouts.app', [
                'title'       => 'Proses Produksi Roster Beton | INDOROSTER — Pabrik Plered Purwakarta',
                'description' => 'Transparansi proses produksi roster beton INDOROSTER dari cetakan hingga pengiriman. Kualitas K-200, presisi tinggi, dan quality control ketat untuk setiap keping roster.',
            ]);
    }
}
