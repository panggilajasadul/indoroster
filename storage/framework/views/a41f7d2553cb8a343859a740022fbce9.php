...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.product-schema','data' => ['product' => $product]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Breadcrumb" class="mb-4 sm:mb-8">
            <ol class="flex flex-wrap items-center gap-1 text-sm text-slate-500">
                <li>
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-terra-500 transition-colors">Beranda</a>
                </li>
                <li aria-hidden="true"><span class="mx-1">/</span></li>
                <li>
                    <a href="<?php echo e(route('catalog')); ?>" class="hover:text-terra-500 transition-colors">Katalog</a>
                </li>
                ...
                <li aria-hidden="true"><span class="mx-1">/</span></li>
                <li>
                    <a href="<?php echo e(route('catalog', ['category' => $product->category->slug])); ?>" class="hover:text-terra-500 transition-colors"><?php echo e($product->category->name); ?></a>
                </li>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <li aria-hidden="true"><span class="mx-1">/</span></li>
                <li>
                    <span class="text-slate-900 font-medium" aria-current="page"><?php echo e($product->name); ?></span>
                </li>
            </ol>
        </nav>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('success')): ?>
            <div class="mb-8 p-4 bg-green-50 border border-green-200 text-green-700 rounded-lg flex items-start gap-3">
                ...
                <div class="flex-grow"><?php echo e(session('success')); ?></div>
                <a href="<?php echo e(route('cart')); ?>" class="whitespace-nowrap font-medium text-green-800 hover:underline">Lihat Keranjang &rarr;</a>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('error')): ?>
            <div class="mb-8 p-4 bg-red-50 border border-red-200 text-red-700 rounded-lg flex items-start gap-3">
                ...
                <div class="flex-grow"><?php echo e(session('error')); ?></div>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="w-full relative bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 aspect-square">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeImage): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeMediaType === 'video'): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_contains($activeImage, 'youtube.com') || str_contains($activeImage, 'youtu.be')): ?>
                                    <?php
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ytId): ?>
                                        <iframe class="absolute inset-0 w-full h-full" src="https://www.youtube.com/embed/<?php echo e($ytId); ?>?autoplay=1&mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
                                    <video src="<?php echo e($activeImage); ?>" class="absolute inset-0 w-full h-full object-cover" controls autoplay muted loop playsinline></video>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php else: ?>
                                <img src="<?php echo e($activeImage); ?>" alt="<?php echo e($product->name); ?>" class="absolute inset-0 w-full h-full object-cover">
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php else: ?>
                    ...
                    <!-- Thumbnails -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->media->count() > 0): ?>
                    <div class="flex flex-row gap-3 overflow-x-auto w-full pb-2 hide-scrollbar shrink-0">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $product->media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $mediaUrl = str_starts_with($media->media_url, 'http') ? $media->media_url : asset('storage/' . $media->media_url);
                            ?>
                            <button wire:click="setActiveImage('<?php echo e($mediaUrl); ?>', '<?php echo e($media->media_type); ?>')" class="relative flex-shrink-0 w-20 h-20 md:w-24 md:h-24 rounded-lg overflow-hidden border-2 transition-all <?php echo e($activeImage === $mediaUrl ? 'border-terra-500' : 'border-transparent hover:border-gray-300'); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($media->media_type === 'image'): ?>
                                    <img src="<?php echo e($mediaUrl); ?>" alt="Thumbnail" class="w-full h-full object-cover">
                                <?php elseif($media->media_type === 'video'): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_contains($media->media_url, 'youtube.com') || str_contains($media->media_url, 'youtu.be')): ?>
                                        <?php
                                            preg_match('/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/\s]{11})/i', $media->media_url, $ytMatches);
                                            $ytThumbId = $ytMatches[1] ?? '';
                                        ?>
                                        <div class="w-full h-full relative">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ytThumbId): ?>
                                                <img src="https://img.youtube.com/vi/<?php echo e($ytThumbId); ?>/mqdefault.jpg" alt="Video thumbnail" class="w-full h-full object-cover">
                                            <?php else: ?>
                                    ...
                                    <?php else: ?>
                                        <div class="w-full h-full relative">
                                            <video src="<?php echo e($mediaUrl); ?>" class="w-full h-full object-cover" autoplay muted loop playsinline></video>
            ...
            <div class="flex flex-col lg:justify-between lg:h-full">
                <div>
                    <div class="mb-4">
                        <h1 class="font-display text-xl sm:text-2xl font-bold text-slate-900 tracking-tight mb-1"><?php echo e($product->name); ?></h1>
                        <div class="flex flex-wrap items-center gap-x-3 gap-y-1.5 text-xs sm:text-sm text-slate-500 mb-3 border-b border-gray-100 pb-3">
                            <span class="inline-flex items-center gap-1.5"><svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg> <?php echo e($product->category->name ?? 'Kategori'); ?></span>
                            <span>•</span>
                            <span class="inline-flex items-center gap-1.5"><svg class="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg> <?php echo e($product->average_rating); ?> (<?php echo e($ratingStats['total']); ?> ulasan)</span>
                            <span>•</span>
                            <span class="text-slate-900 font-semibold"><?php echo e($product->formatted_total_sold); ?> Terjual</span>
                        </div>

                        <div class="flex items-baseline gap-2.5 flex-wrap mt-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$selectedVariant && $product->variants->count() > 0): ?>
                                <span class="text-2xl sm:text-3xl font-black text-terra-500"><?php echo e($this->priceRange); ?></span>
                            <?php else: ?>
                                <span class="text-2xl sm:text-3xl font-black text-terra-500">Rp<?php echo e(number_format($this->activePrice, 0, ',', '.')); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->original_price > 0 && (!$selectedVariant || $product->original_price > $this->activePrice)): ?>
                                <span class="text-sm sm:text-base text-slate-400 line-through">Rp<?php echo e(number_format($product->original_price, 0, ',', '.')); ?></span>
                                <?php
                                    $discountPercentage = round((($product->original_price - $this->activePrice) / $product->original_price) * 100);
                                ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discountPercentage > 0): ?>
                                    <span class="text-[10px] sm:text-xs font-bold text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded shadow-sm border border-slate-200/50">-<?php echo e($discountPercentage); ?>%</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 sm:mb-5">
                        ...
                        <div class="flex flex-wrap gap-2.5">
                            ...
                            <label class="relative cursor-pointer">
                                <input type="radio" wire:model.live="selectedVariant" value="<?php echo e($variant->id); ?>" class="peer sr-only" name="variant">
                ...
                <div class="flex flex-col gap-3 mt-4">
                    ...
                    <div class="p-4 bg-terra-50 rounded-xl border border-terra-100 shadow-sm w-full">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <p class="text-[10px] text-slate-500 ml-auto italic mt-0.5">*Ukuran <?php echo e($product->parsed_dimensions['width'] ?? '20'); ?>x<?php echo e($product->parsed_dimensions['height'] ?? '20'); ?> cm</p>
                        </div>
                        ...
                        <div class="flex flex-col lg:flex-row items-end gap-2.5">
                            ...
                            <div class="flex items-center justify-between p-2 bg-white rounded-lg border border-terra-100 w-full lg:flex-1 h-9">
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <div class="text-base font-black text-terra-600 leading-none"><?php echo e($calculatedRequirement); ?> <span class="text-[10px] font-normal text-slate-500">pcs</span></div>
                                </div>
                            ...
                            <div class="w-full lg:w-auto shrink-0">
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="flex items-center border border-gray-300 rounded-md bg-white w-28 h-10">
                                        ...
                                        <input type="number" wire:model.blur="quantity" class="w-12 h-full text-center border-0 focus:ring-0 text-slate-900 font-bold p-0 text-sm" min="<?php echo e($product->min_order ?? 1); ?>" max="<?php echo e($this->activeStock); ?>">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-xs sm:text-sm text-slate-500 font-semibold">Tersedia <?php echo e($this->activeStock); ?></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->min_order > 0): ?>
                                            <span class="text-[10px] text-terra-600 font-bold">Min. pembelian <?php echo e($product->min_order); ?> pcs</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="space-y-5">
                                <div class="flex items-center justify-between pb-4 border-b border-gray-50">
                                    ...
                                    <span class="font-bold text-slate-900 text-right"><?php echo e($product->dimensions ?: 'Standard'); ?></span>
                                </div>
                                <div class="flex items-center justify-between pb-4 border-b border-gray-50">
                                    <span class="text-slate-500 text-sm">Berat per Pcs</span>
                                    <span class="font-bold text-slate-900 text-right"><?php echo e($product->weight ?: '0'); ?> kg</span>
                                </div>
                                <div class="flex items-center justify-between pb-4 border-b border-gray-50">
                                    <span class="text-slate-500 text-sm">Kode Produk (SKU)</span>
                                    <span class="font-mono text-sm bg-slate-100 px-3 py-1 rounded-md text-slate-700 tracking-wider"><?php echo e($product->sku ?: '-'); ?></span>
                                </div>
                                <div class="flex items-center justify-between pb-4 border-b border-gray-50">
                                    <span class="text-slate-500 text-sm">Kategori Produk</span>
                                    <span class="font-bold text-terra-600 text-right"><?php echo e($product->category->name); ?></span>
                                </div>
                            </div>
                        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recommendedProducts->count() > 0): ?>
        <div class="mt-20 border-t border-gray-100 pt-16">
            <div class="flex flex-col sm:flex-row sm:items-baseline justify-between mb-8 gap-4">
                ...
                <a href="<?php echo e(route('catalog')); ?>" class="text-sm font-bold text-terra-600 hover:text-terra-700 transition-colors flex items-center gap-1.5 shrink-0 group">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recommendedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('product.detail', $recProduct->slug)); ?>" class="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 group flex flex-col overflow-hidden relative hover:border-terra-400">
                    <!-- Media Section -->
                    <div class="relative aspect-square overflow-hidden bg-gray-50">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recDisplay): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recDisplay->media_type === 'video' && !str_contains($recDisplay->media_url, 'youtube.com') && !str_contains($recDisplay->media_url, 'youtu.be')): ?>
                                <video src="<?php echo e($recDisplay->formatted_url); ?>" 
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                    autoplay muted loop playsinline></video>
                            <?php else: ?>
                                <img src="<?php echo e($recDisplay->media_type === 'image' ? $recDisplay->formatted_url : $recProduct->primary_image); ?>" alt="<?php echo e($recProduct->name); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php else: ?>
                        ...
                        <!-- Badges -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recProduct->discount_percentage > 0): ?>
                            <div class="absolute top-0 right-0 bg-red-50 text-red-600 border-l border-b border-red-100 text-[10px] font-bold px-2 py-0.5 rounded-bl-lg z-10 shadow-sm">
                                <?php echo e($recProduct->discount_percentage); ?>% OFF
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <!-- Video Indicator -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recProduct->has_video): ?>
                    ...
                    <div class="p-4 flex flex-col flex-grow">
                        <div class="text-xs text-slate-500 mb-1 font-semibold uppercase tracking-wider"><?php echo e($recProduct->category->name ?? 'Roster'); ?></div>
                        <div class="text-sm text-slate-800 leading-snug mb-2 line-clamp-2 font-bold group-hover:text-terra-600 transition-colors">
                            <?php echo e($recProduct->name); ?>
                        ...
                        <div class="mt-auto">
                            ...
                            <div class="flex items-center gap-1.5 mb-2.5">
                                ...
                                <span class="text-[11px] font-bold text-slate-700"><?php echo e($recProduct->average_rating); ?></span>
                                <span class="text-[11px] text-slate-400">•</span>
                                <span class="text-[11px] text-slate-500 font-medium"><?php echo e($recProduct->total_sold > 0 ? $recProduct->formatted_total_sold . ' terjual' : '0 terjual'); ?></span>
                            </div>

                            <div class="flex items-baseline justify-between gap-1 flex-wrap pt-2 border-t border-slate-50">
                                <span class="text-sm font-extrabold text-terra-600 leading-none"><?php echo e($recProduct->formatted_price_range); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recProduct->has_discount): ?>
                                    <span class="text-[10px] text-slate-400 line-through leading-none">Rp<?php echo e(number_format($recProduct->original_price, 0, ',', '.')); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mt-20 border-t border-gray-100 pt-16">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div class="lg:col-span-1 bg-terra-50 rounded-2xl p-8 flex flex-col items-center justify-center text-center border border-terra-100">
                    <div class="text-5xl font-extrabold text-terra-600 mb-2"><?php echo e($product->average_rating); ?> <span class="text-2xl text-terra-400 font-normal">/ 5</span></div>
                    <div class="flex gap-1 mb-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i=1; $i<=5; $i++): ?>
                            <svg class="w-6 h-6 <?php echo e($i <= round($product->average_rating) ? 'text-amber-400' : 'text-gray-300'); ?>" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                        <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <p class="text-sm font-bold text-slate-600 uppercase tracking-wider"><?php echo e($ratingStats['total']); ?> PENILAIAN</p>
                </div>

                <!-- Rating Bars & Filter -->
                <div class="lg:col-span-3">
                    <div class="flex flex-wrap gap-3 items-center mb-8">
                        <button wire:click="setRatingFilter(0)" class="px-6 py-2 rounded-full text-sm font-semibold transition-all <?php echo e($ratingFilter == 0 ? 'bg-terra-500 text-white shadow-lg shadow-terra-500/20' : 'bg-white border border-gray-200 text-slate-600 hover:border-terra-300'); ?>">
                            Semua
                        </button>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $ratingStats['stats']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $star => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button wire:click="setRatingFilter(<?php echo e($star); ?>)" class="px-6 py-2 rounded-full text-sm font-semibold transition-all flex items-center gap-2 <?php echo e($ratingFilter == $star ? 'bg-terra-500 text-white shadow-lg shadow-terra-500/20' : 'bg-white border border-gray-200 text-slate-600 hover:border-terra-300'); ?>">
                            <?php echo e($star); ?> Bintang (<?php echo e($stat['count']); ?>)
                        </button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <div class="space-y-3 max-w-md">
                        ...
                        <div class="flex items-center gap-4">
                            <span class="text-sm font-medium text-slate-600 w-16"><?php echo e($star); ?> Bintang</span>
                            <div class="flex-grow h-2 bg-gray-100 rounded-full overflow-hidden">
                                <div class="h-full bg-amber-400 rounded-full" style="width: <?php echo e($stat['percent']); ?>%"></div>
                            </div>
                            <span class="text-xs text-slate-400 w-10"><?php echo e(round($stat['percent'])); ?>%</span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            ...
            <div class="space-y-8 mb-16">
                ...
                <div class="flex gap-6 pb-8 border-b border-gray-50 last:border-0" wire:key="review-<?php echo e($review->id); ?>">
                    <div class="shrink-0">
                    ...
                    <div class="flex-grow">
                        <div class="flex items-center justify-between mb-1">
                            <h4 class="font-display font-bold text-slate-900"><?php echo e($review->masked_name); ?></h4>
                            <span class="text-xs text-slate-400"><?php echo e($review->created_at->diffForHumans()); ?></span>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($review->reviewer_location): ?>
                        <div class="text-xs text-terra-600 font-medium mb-3 flex items-center gap-1">
                            ...
                            <?php echo e($review->reviewer_location); ?>

                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div class="flex gap-0.5 mb-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i=1; $i<=5; $i++): ?>
                                <svg class="w-4 h-4 <?php echo e($i <= $review->rating ? 'text-amber-400' : 'text-gray-200'); ?>" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                            <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <p class="text-slate-600 leading-relaxed whitespace-pre-line mb-4"><?php echo e($review->content); ?></p>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $review->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isVideo): ?>
                                    <button x-data @click="$dispatch('open-lightbox', { url: '<?php echo e(asset('storage/' . $image)); ?>', type: 'video' })" class="relative w-20 h-20 rounded-lg overflow-hidden border border-gray-100 hover:border-terra-300 transition-all bg-black flex items-center justify-center">
                                        <video src="<?php echo e(asset('storage/' . $image)); ?>" class="w-full h-full object-cover opacity-60" muted playsinline></video>
                                ...
                                <?php else: ?>
                                    <button x-data @click="$dispatch('open-lightbox', { url: '<?php echo e(asset('storage/' . $image)); ?>', type: 'image' })" class="relative w-20 h-20 rounded-lg overflow-hidden border border-gray-100 hover:border-terra-300 transition-all">
            ...
            <div class="bg-slate-50 rounded-3xl p-8 lg:p-12 border border-gray-100">
                <div class="max-w-3xl">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('review_success')): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i=1; $i<=5; $i++): ?>
                                <button type="button" wire:click="$set('rating', <?php echo e($i); ?>)" class="focus:outline-none transition-transform active:scale-95">
                                    <svg class="w-10 h-10 <?php echo e($i <= $rating ? 'text-amber-400' : 'text-gray-200'); ?>" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                                </button>
                                <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-4 items-start">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($review_images): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $review_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative w-24 h-24 rounded-2xl overflow-hidden border border-gray-200 bg-slate-900">
                                        ...
                                        <?php else: ?>
                                            <div class="w-full h-full flex flex-col items-center justify-center p-2 text-center text-white">
                                                ...
                                                <span class="text-[8px] text-slate-300 truncate w-full" title="<?php echo e($image->getClientOriginalName()); ?>"><?php echo e($image->getClientOriginalName()); ?></span>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        
                                        <button type="button" wire:click="$set('review_images.<?php echo e($index); ?>', null)" class="absolute top-1 right-1 w-6 h-6 bg-red-500 text-white rounded-full flex items-center justify-center shadow-md cursor-pointer hover:bg-red-600 transition-colors z-10">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['review_images.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    ?>
    <script type="application/ld+json"><?php echo json_encode($schemaData, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT); ?></script>
</div>
<?php /**PATH C:\xampp\htdocs\indoroster\resources\views/livewire/product-detail.blade.php ENDPATH**/ ?>