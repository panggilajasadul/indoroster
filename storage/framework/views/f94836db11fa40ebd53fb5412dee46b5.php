<div class="py-12 bg-slate-50 min-h-screen" x-data="{ 
    fullSizeModal: <?php echo e($initialActiveIndex !== null ? 'true' : 'false'); ?>, 
    activeIndex: <?php echo e($initialActiveIndex !== null ? $initialActiveIndex : 0); ?>, 
    isMuted: true, 
    isLoggedIn: <?php echo e(auth()->check() ? 'true' : 'false'); ?>, 
    commentDrawerOpen: false, 
    activeVideoId: <?php if ((object) ('activeVideoId') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('activeVideoId'->value()); ?>')<?php echo e('activeVideoId'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('activeVideoId'); ?>')<?php endif; ?>, 
    videos: <?php if ((object) ('videos') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('videos'->value()); ?>')<?php echo e('videos'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('videos'); ?>')<?php endif; ?>,
    showToast: false,
    toastMessage: '',
    _opening: false,
...
">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-8" wire:loading.class="opacity-50 transition-opacity">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div 
                    ...
                    @click="openModal(<?php echo e($index); ?>)">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($video['product'])): ?>
                        <div class="absolute top-3 left-3 z-10 pointer-events-auto">
                            <div 
                                @click.stop="window.location.href = '<?php echo e(url('/produk/' . $video['product']['slug'])); ?>'"
                                ...
                                <div class="flex flex-col leading-tight">
                                    <span class="truncate max-w-[100px] text-[9px] text-slate-500 group-hover/badge:text-white/80 font-medium transition-colors"><?php echo e($video['product']['name']); ?></span>
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-4 md:p-6 pointer-events-none">
                        ...
                        <div class="flex items-center gap-2.5 mt-2 text-white/90 text-[10px] font-semibold drop-shadow-md">
                            <span class="flex items-center gap-1">
                                ...
                                <span x-text="videos[<?php echo e($index); ?>]?.likes_count || 0"><?php echo e($video['likes_count']); ?></span>
                            </span>
                            <span class="flex items-center gap-1">
                                ...
                                <span x-text="videos[<?php echo e($index); ?>]?.comments_count || 0"><?php echo e($video['comments_count']); ?></span>
                            </span>
                        </div>
                    </div>
    ...
    <div 
        ...
        <div 
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div 
                    id="modal-video-<?php echo e($index); ?>"
                    ...
                    <div 
                        ...
                        <video 
                            id="video-element-<?php echo e($index); ?>"
                        ...
                        <div class="absolute bottom-28 left-4 right-4 z-[110] pointer-events-none text-left">
                            <div class="flex items-center gap-2 mb-2">
                                <div class="w-8 h-8 rounded-full border border-white/40 flex items-center justify-center shadow-lg relative overflow-hidden"
                                     :class="videos[<?php echo e($index); ?>]?.type === 'gallery' ? 'bg-terra-500' : 'bg-slate-600'">
                                    <template x-if="videos[<?php echo e($index); ?>]?.type === 'gallery'">
                                        <span class="text-[8px] font-black text-white">INDO</span>
                                    </template>
                                    <template x-if="videos[<?php echo e($index); ?>]?.type !== 'gallery'">
                                        <span class="text-xs font-bold text-white uppercase" x-text="videos[<?php echo e($index); ?>]?.reviewer_name?.charAt(0) || 'U'"></span>
                                    </template>
                                </div>
                                <span class="text-white text-xs font-bold tracking-[0.2em] uppercase drop-shadow-lg" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.6);" x-text="videos[<?php echo e($index); ?>]?.reviewer_name || 'INDOROSTER OFFICIAL'">INDOROSTER OFFICIAL</span>
                            </div>
                            <h2 class="font-display text-white text-sm md:text-base font-normal drop-shadow-lg max-w-[85%]" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.8);" x-text="videos[<?php echo e($index); ?>]?.title">
                                <?php echo e($video['title']); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($video['product'])): ?>
                            <div class="absolute bottom-6 left-4 right-4 z-[110] pointer-events-auto">
                                <a 
                                    href="<?php echo e(url('/produk/' . $video['product']['slug'])); ?>" 
                                    ...
                                    <div class="w-12 h-12 rounded-xl overflow-hidden bg-slate-100 flex-shrink-0 border border-slate-200">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($video['product']['image']): ?>
                                            <img src="<?php echo e($video['product']['image']); ?>" alt="<?php echo e($video['product']['name']); ?>" class="w-full h-full object-cover">
                                        <?php else: ?>
                                    ...
                                    <div class="flex-grow min-w-0 text-left">
                                        <p class="text-xs font-bold text-slate-800 line-clamp-1 group-hover:text-terra-600 transition-colors">
                                            <?php echo e($video['product']['name']); ?>

                                        </p>
                                        <p class="text-[11px] font-black text-terra-600 mt-0.5">
                                            <?php echo e($video['product']['formatted_price']); ?> • Beli Sekarang
                                        </p>
                                    </div>
                        ...
                        <div class="absolute right-4 bottom-32 z-[115] flex flex-col items-center gap-4 text-white">
                                ...
                                <div class="w-11 h-11 rounded-full border border-white/40 bg-slate-800 flex items-center justify-center shadow-lg relative">
                                    ...
                                    <template x-if="videos[<?php echo e($index); ?>]?.type !== 'gallery'">
                                        <div class="w-full h-full rounded-full bg-slate-600 flex items-center justify-center">
                                            <span class="text-sm font-bold text-white uppercase" x-text="videos[<?php echo e($index); ?>]?.reviewer_name?.charAt(0) || 'U'"></span>
                                        </div>
                                    </template>
                                    <!-- Verified Badge -->
                                    <template x-if="videos[<?php echo e($index); ?>]?.type === 'gallery'">
                            ...
                            <!-- Like Button -->
                            <button 
                                @click.stop="if (!isLoggedIn) { window.location.href = '<?php echo e(route('login')); ?>'; } else { $wire.toggleLike(videos[<?php echo e($index); ?>].id) }" 
                                ...
                                <div class="w-11 h-11 rounded-full bg-black/40 backdrop-blur-md flex items-center justify-center transition-all duration-200 group-hover:scale-110 border border-white/10 active:scale-95 text-white"
                                    :class="videos[<?php echo e($index); ?>]?.is_liked ? 'text-rose-500' : ''">
                                    <svg xmlns="http://www.w3.org/2000/svg" :fill="videos[<?php echo e($index); ?>]?.is_liked ? 'currentColor' : 'none'" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                                    </svg>
                                </div>
                                <span class="text-[11px] font-bold mt-1 drop-shadow-md" x-text="videos[<?php echo e($index); ?>]?.likes_count || 0"></span>
                            </button>

                            <!-- Comment Button -->
                            <button 
                                @click.stop="if (!isLoggedIn) { window.location.href = '<?php echo e(route('login')); ?>'; } else { activeVideoId = videos[<?php echo e($index); ?>].id; commentDrawerOpen = true; }" 
                                class="flex flex-col items-center justify-center group focus:outline-none cursor-pointer">
                                <div class="w-11 h-11 rounded-full bg-black/40 backdrop-blur-md flex items-center justify-center transition-all duration-200 group-hover:scale-110 border border-white/10 active:scale-95 text-white">
                                ...
                                <span class="text-[11px] font-bold mt-1 drop-shadow-md" x-text="videos[<?php echo e($index); ?>]?.comments_count || 0"></span>
                            </button>

                            <!-- Share Button -->
                            <button 
                                @click.stop="
                                    const shareUrl = `${window.location.origin}${window.location.pathname}?video=${videos[<?php echo e($index); ?>].id}`;
                                    if (navigator.share) {
                                        navigator.share({
                                            title: videos[<?php echo e($index); ?>].title,
            ...
            <div class="p-4 border-t border-white/10 bg-slate-950/40">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($replyToCommentId): ?>
                    <div class="flex items-center justify-between bg-terra-500/10 border border-terra-500/20 rounded-xl px-3 py-1.5 mb-2 text-xs">
                        <span class="text-slate-300">
                            Membalas <span class="font-bold text-terra-400">@<span><?php echo e($replyToUserName); ?></span></span>
                        </span>
                        <button 
                            type="button"
                ...
                <form wire:submit.prevent="submitComment" class="flex gap-2">
                    <input 
                        ...
                        placeholder="<?php echo e($replyToCommentId ? 'Tulis balasan...' : 'Tulis komentar...'); ?>"
...
<?php /**PATH C:\xampp\htdocs\indoroster\resources\views/livewire/video-inspiration.blade.php ENDPATH**/ ?>