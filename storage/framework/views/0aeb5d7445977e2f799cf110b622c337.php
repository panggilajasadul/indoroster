...
<body class="font-sans antialiased bg-slate-900 text-white min-h-screen flex flex-col items-center justify-center">
    ...
    <div class="mb-12">
        <img src="<?php echo e(asset('assets/logo_indoroster-text.png')); ?>" alt="Indoroster Logo" class="h-12 md:h-16">
    </div>
    ...
    <div class="text-center px-4">
        ...
        <p class="text-slate-600 text-sm mt-12">
            Butuh bantuan? 
            <a href="<?php echo e(url('/kontak')); ?>" class="text-terra-400 hover:text-terra-300 underline">Hubungi kami</a>
        </p>
    </div>
...
<?php /**PATH C:\xampp\htdocs\indoroster\resources\views/errors/403.blade.php ENDPATH**/ ?>