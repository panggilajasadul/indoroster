    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-accent/5 rounded-3xl p-8 md:p-16 border border-accent/10 flex flex-col md:flex-row items-center gap-12">
            <div class="flex-1">
                ...
                <h2 class="text-3xl md:text-4xl font-bold font-display text-slate-900 mb-6"><?php echo $title; ?></h2>
                <p class="text-lg text-slate-600 mb-8 leading-relaxed">
                    <?php echo $content; ?>

                </p>
                <a href="<?php echo e($buttonUrl ?: 'https://wa.me/' . preg_replace('/[^0-9]/', '', \App\Models\SiteSetting::getValue('whatsapp_number', '081234567890'))); ?>" target="_blank" class="inline-flex items-center gap-2 bg-accent hover:bg-accent/90 text-black px-6 py-3 rounded-md font-bold transition-colors">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                    <?php echo e($buttonText ?: 'Hubungi Kami'); ?>
...
<?php /**PATH C:\xampp\htdocs\indoroster\resources\views/components/blocks/shipping-info.blade.php ENDPATH**/ ?>