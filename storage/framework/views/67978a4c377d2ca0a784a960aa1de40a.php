...
<div id="heroSlider" class="relative bg-slate-900 overflow-hidden min-h-[620px] sm:min-h-[580px] md:min-h-[70vh] lg:min-h-[75vh]">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bannerCount > 0): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            >
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($banner['image_link'])): ?>
                <a href="<?php echo e($banner['image_link']); ?>" class="absolute inset-0 z-0 block">
                ...
                <video 
                    ...
                    class="w-full h-full <?php echo e($imageFitClass); ?> <?php echo e($blurClass . $blurScaleClass); ?>"
                    style="opacity: <?php echo e($imgOpacity); ?>;"
                ...
                >
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="absolute inset-0 sm:hidden" style="background: <?php echo e($rgba); ?>;"></div>
                <div class="absolute inset-0 hidden sm:block" style="background: <?php echo e($desktopGradient); ?>;"></div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($banner['image_link'])): ?>
                </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                
                <div class="absolute inset-0 flex items-center py-12 sm:py-16 md:py-0 z-10 pointer-events-none">
                    <div class="<?php echo e($alignParentClass); ?> pointer-events-auto">
                        <div class="<?php echo e($alignContainerClass); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($banner['top_text'])): ?>
                            <div class="<?php echo e($badgeParentClass); ?>">
                                <h1 class="text-sm font-bold text-terra-400 uppercase tracking-widest mb-3 flex items-center gap-2">
                                    ...
                                    <?php echo e($banner['top_text']); ?>

                                    <span class="w-5 h-px bg-terra-500"></span>
                                </h1>
                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($banner['badge'])): ?>
                            <div class="<?php echo e($badgeParentClass); ?>">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($banner['title'])): ?>
                            <h2 class="<?php echo e($banner['font_family'] ?? 'font-display'); ?> text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-white leading-tight mb-6 sm:mb-8 tracking-normal">
                                <?php echo $banner['title'] ?? ''; ?>

                            </h2>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($banner['subtitle'])): ?>
                            <p class="<?php echo e($subtitleClass); ?>">
                                <?php echo $banner['subtitle'] ?? ''; ?>

                            </p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div class="<?php echo e($alignButtonClass); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($banner['button_text'])): ?>
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($banner['button_2_text'])): ?>
                                    <a href="<?php echo e($banner['button_2_url'] ?? '#'); ?>" class="inline-flex items-center justify-center border border-terra-500 bg-black/20 hover:bg-terra-500 hover:text-white text-terra-500 px-6 sm:px-8 py-3 sm:py-3.5 rounded-full font-semibold text-sm sm:text-base transition-all text-center backdrop-blur-sm">
                                        <?php echo e($banner['button_2_text']); ?>
    ...
    <?php else: ?>
        ...
        <div class="absolute inset-0 flex items-center py-12 sm:py-16 md:py-0 bg-slate-900">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-12 md:mt-0 relative z-10">
                <div class="max-w-3xl">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($data['badge'] ?? ''): ?>
                        <span class="inline-block px-4 py-1.5 rounded-full bg-accent/10 border border-accent/20 text-accent font-black text-xs uppercase tracking-[0.2em] mb-6 sm:mb-8"><?php echo e($data['badge']); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
                        <a href="<?php echo e($data['primary_button_url'] ?? '/produk'); ?>" class="inline-flex items-center justify-center px-6 sm:px-10 py-3.5 sm:py-5 bg-accent text-black font-black text-xs uppercase tracking-widest hover:scale-105 transition-all shadow-[0_0_40px_rgba(255,102,0,0.3)] text-center">
                            <?php echo e($data['primary_button_text'] ?? 'Lihat Produk'); ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\xampp\htdocs\indoroster\resources\views/components/blocks/hero.blade.php ENDPATH**/ ?>