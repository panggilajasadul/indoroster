        ...
        <div class="max-h-[300px] overflow-y-auto divide-y divide-slate-50">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="/keranjang" wire:navigate class="flex items-center gap-3 px-4 py-3 hover:bg-slate-50 transition-colors group">
                    <img src="<?php echo e($item['image']); ?>" alt="<?php echo e($item['name']); ?>" class="w-10 h-10 rounded border border-slate-100 object-cover flex-shrink-0">
                    <div class="flex-grow min-w-0">
                        <p class="text-xs font-medium text-slate-800 truncate group-hover:text-terra-600 transition-colors"><?php echo e($item['name']); ?></p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['variant_name']): ?>
                            <p class="text-[10px] text-slate-400 mt-0.5">Varian: <?php echo e($item['variant_name']); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <p class="text-[10px] text-slate-400 mt-0.5">Jumlah: <?php echo e($item['quantity']); ?></p>
                    </div>
                    <div class="text-right flex-shrink-0">
                        <span class="text-xs font-bold text-terra-600"><?php echo e($item['price']); ?></span>
                    </div>
                </a>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($count > 0): ?>
            <div class="px-4 py-3 bg-slate-50/50 flex items-center justify-between">
                <span class="text-[11px] text-slate-500 font-medium">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($count > 5): ?>
                        <?php echo e($count - 5); ?> Produk Lainnya
                    <?php else: ?>
                        <?php echo e($count); ?> Produk di Keranjang
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </span>
...
<?php /**PATH C:\xampp\htdocs\indoroster\resources\views/livewire/cart-count.blade.php ENDPATH**/ ?>