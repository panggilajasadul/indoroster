...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('assets/logo_indoroster_no_text.PNG')); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset('assets/logo_indoroster_no_text.PNG')); ?>">
        ...
        <nav class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Top">
            <div class="w-full h-16 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2 sm:gap-3 lg:gap-5 lg:w-1/4">
                    ...
                    <!-- Logo -->
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 group flex-shrink-0">
                        <img src="<?php echo e(asset('assets/logo_indoroster_no_text.PNG')); ?>" alt="Indoroster Logo" class="h-7 sm:h-8 md:h-9 w-auto transition-transform duration-300 group-hover:rotate-6">
                ...
                <div class="hidden lg:flex items-center justify-center space-x-8 lg:w-2/4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $navigationMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(url($menu->url)); ?>" target="<?php echo e($menu->target); ?>" class="text-sm font-semibold text-slate-600 hover:text-terra-500 transition-colors whitespace-nowrap"><?php echo e($menu->label); ?></a>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2479275134-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2479275134-1', $__key);
...
?>
                            ...
                            <div class="relative ml-1" x-data="{ userMenuOpen: false, userTimer: null }"
                                ...
                                <div x-show="userMenuOpen" 
                                    ...
                                    <a href="<?php echo e(route('member.orders')); ?>" wire:navigate class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:text-terra-500 transition-colors">
                                    ...
                                    <a href="<?php echo e(route('member.addresses')); ?>" wire:navigate class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:text-terra-500 transition-colors">
                                        <svg class="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                                        Buku Alamat
                                    </a>
                                    <a href="<?php echo e(route('member.notifications')); ?>" wire:navigate class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:text-terra-500 transition-colors">
                                        <svg class="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
                                        Notifikasi
                                    </a>
                                    <div class="border-t border-slate-100 my-1"></div>
                                    <a href="<?php echo e(route('logout')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-red-600 hover:bg-red-50 transition-colors">
                            ...
                            <div class="relative ml-1" x-data="{ userMenuOpen: false, userTimer: null }"
                                ...
                                <div x-show="userMenuOpen" 
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <a href="<?php echo e(route('verification.notice')); ?>" class="block w-full text-center bg-terra-500 hover:bg-terra-600 text-white text-sm font-bold py-2.5 px-4 rounded-lg transition-colors">
                                            Verifikasi Sekarang
                                        </a>
                                    </div>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2479275134-2', $__key);
...
?>
                        <div class="hidden sm:flex items-center gap-3 ml-2">
                            <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-slate-600 hover:text-terra-500 transition-colors px-2">Masuk</a>
                            <a href="<?php echo e(route('register')); ?>" class="text-sm font-bold text-white bg-terra-500 hover:bg-terra-600 px-4 py-2 rounded-full shadow-sm transition-all duration-200">Daftar</a>
                        </div>
                        <a href="<?php echo e(route('login')); ?>" class="sm:hidden p-2 text-slate-600 hover:text-terra-500 hover:bg-slate-100 rounded-full transition ml-1" aria-label="Masuk">
                        ...
                        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-2xl">
                            <div class="flex items-center justify-between px-6 py-5 border-b border-slate-100">
                                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3">
                                    <img src="<?php echo e(asset('assets/logo_indoroster_no_text.PNG')); ?>" alt="Indoroster" class="h-7 w-auto">
                            ...
                            <div class="px-4 py-6">
                                <nav class="flex flex-col space-y-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $navigationMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(url($menu->url)); ?>" target="<?php echo e($menu->target); ?>" class="flex items-center px-4 py-3.5 text-base font-bold text-slate-700 hover:bg-terra-50 hover:text-terra-600 rounded-xl transition-colors group">
                            ...
                            <div class="mt-auto border-t border-slate-100 px-6 py-6 bg-slate-50">
                                ...
                                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', \App\Models\SiteSetting::getValue('whatsapp_number', '081234567890'))); ?>" target="_blank" class="flex items-center gap-3 text-sm font-medium text-slate-700 hover:text-green-600 mb-4 transition-colors">
                                ...
                                <a href="<?php echo e(route('order.tracking')); ?>" class="flex items-center gap-3 text-sm font-medium text-slate-700 hover:text-terra-600 transition-colors">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showOnboarding): ?>
                ...
                <div class="bg-amber-50 border-b border-amber-200 px-4 py-3 sm:px-6 lg:px-8">
                    <div class="max-w-screen-2xl mx-auto flex items-center justify-between flex-wrap gap-2">
                        ...
                        <a href="<?php echo e(route('member.addresses')); ?>" class="text-sm font-bold text-amber-900 bg-amber-200 hover:bg-amber-300 px-4 py-1.5 rounded-lg transition-colors whitespace-nowrap">
                            Tambahkan Alamat
                        </a>
                    </div>
                </div>
                ...
                <div x-data="{ showModal: !sessionStorage.getItem('onboarding_address_dismissed') }" 
                    ...
                    <div x-show="showModal" 
                        ...
                        <div class="space-y-3">
                            <a href="<?php echo e(route('member.addresses')); ?>" class="block w-full bg-terra-600 hover:bg-terra-700 text-white font-bold py-3.5 px-4 rounded-xl shadow-sm transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                <div class="col-span-1 md:col-span-2">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 mb-6">
                        <img src="<?php echo e(asset('assets/logo_indoroster_no_text.PNG')); ?>" alt="Indoroster Logo" class="h-9 w-auto brightness-0 invert">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('gallery')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Galeri Proyek</a></li>
                        <li><a href="<?php echo e(route('video-inspiration')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Indoroster Video</a></li>
                        <li><a href="<?php echo e(route('production')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Proses Produksi</a></li>
                        <li><a href="<?php echo e(route('catalog')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Katalog Produk</a></li>
                        <li><a href="<?php echo e(route('order.tracking')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Lacak Pesanan</a></li>
                        <li><a href="<?php echo e(route('about-us')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Tentang Kami</a></li>
                        <li><a href="<?php echo e(route('contact')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Kontak</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3 text-sm text-slate-400">
                            ...
                            <span><?php echo e(\App\Models\SiteSetting::getValue('factory_address', 'Plered, Purwakarta, Jawa Barat')); ?></span>
                        </li>
                        <li class="flex items-center gap-3 text-sm text-slate-400">
                            <svg class="w-5 h-5 text-terra-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                            <span><?php echo e(\App\Models\SiteSetting::getValue('whatsapp_number', '0812-3456-7890')); ?></span>
                        </li>
                        <li class="flex items-center gap-3 text-sm text-slate-400">
                            ...
                            <span><?php echo e(\App\Models\SiteSetting::getValue('contact_email', 'hello@indoroster.com')); ?></span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-sm text-slate-500">&copy; <?php echo e(date('Y')); ?> Indoroster. All rights reserved.</p>
                <div class="flex space-x-5">
                    <!-- TikTok -->
                    <a href="<?php echo e(\App\Models\SiteSetting::getValue('tiktok_url', '#')); ?>" target="_blank" rel="noopener" class="text-slate-500 hover:text-white transition-colors" aria-label="TikTok">
                    ...
                    <!-- Instagram -->
                    <a href="<?php echo e(\App\Models\SiteSetting::getValue('instagram_url', '#')); ?>" target="_blank" rel="noopener" class="text-slate-500 hover:text-white transition-colors" aria-label="Instagram">
                    ...
                    <!-- YouTube -->
                    <a href="<?php echo e(\App\Models\SiteSetting::getValue('youtube_url', '#')); ?>" target="_blank" rel="noopener" class="text-slate-500 hover:text-white transition-colors" aria-label="YouTube">
    ...
    <?php $waNumber = preg_replace('/[^0-9]/', '', \App\Models\SiteSetting::getValue('whatsapp_number', '081234567890')); ?>
...
<?php /**PATH C:\xampp\htdocs\indoroster\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>