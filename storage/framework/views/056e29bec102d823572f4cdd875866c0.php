<div class="bg-slate-50 min-h-screen py-12">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$searched || !$order): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['contactQuery'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
            ...
            <div>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                    <div>
                        ...
                        <h1 class="font-display text-fluid-h1 font-black text-slate-900 tracking-tight">Status Pesanan #<?php echo e($order->order_number); ?></h1>
                    ...
                    <div>
                        ...
                        ?>
                        <span class="font-display font-bold text-xs px-4 py-2 rounded-full border uppercase tracking-wider <?php echo e($statusColors); ?>">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($order->status, ['shipped', 'delivered', 'completed'])): ?>
                                ...
                                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->courier): ?>
                                        <div class="bg-white/10 rounded-xl p-3 border border-white/10 text-xs shrink-0 w-full md:w-auto">
                                            ...
                                            <p class="font-bold mt-1 text-sm text-white">Sopir: <?php echo e($order->courier); ?></p>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->tracking_number): ?>
                                                <p class="text-white/80 mt-0.5">Plat Truk: <span class="bg-white text-slate-900 px-1.5 py-0.5 rounded font-mono font-bold"><?php echo e($order->tracking_number); ?></span></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->courier_phone): ?>
                                                <div class="mt-2.5">
                                                    ...
                                                    ?>
                                                    <a href="https://wa.me/<?php echo e($waPhone); ?>?text=<?php echo e($waText); ?>" target="_blank" class="inline-flex items-center gap-1 font-bold text-emerald-400 hover:text-emerald-300 transition-colors">
                            ...
                            <div class="relative pl-6 border-l-2 border-slate-200 space-y-10 ml-3">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute -left-[37px] top-0.5 w-6 h-6 rounded-full flex items-center justify-center border-2 transition-all duration-300
                                        <?php echo e($step1_done ? 'bg-emerald-500 border-emerald-500 text-white' : ($step1_active ? 'bg-white border-amber-500 text-amber-500 scale-110 shadow-lg shadow-amber-500/20' : 'bg-white border-slate-300 text-slate-400')); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step1_done): ?>
                                    ...
                                    <div class="pl-4">
                                        <div class="flex items-center justify-between gap-4 flex-wrap">
                                            ...
                                            <span class="text-[10px] font-semibold text-slate-400 font-mono"><?php echo e($order->created_at->format('d M Y, H:i')); ?> WIB</span>
                                        </div>
                                        <p class="text-xs text-slate-500 mt-1 leading-relaxed">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step1_done): ?>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->paid_at): ?>
                                                    (Terverifikasi pada <?php echo e($order->paid_at->format('d M Y, H:i')); ?>)
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php else: ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$step1_done && $status === 'pending_payment'): ?>
                                            <div class="mt-3">
                                ...
                                <div class="relative">
                                    <!-- Indicator Node -->
                                    <div class="absolute -left-[37px] top-0.5 w-6 h-6 rounded-full flex items-center justify-center border-2 transition-all duration-300
                                        <?php echo e($step2_done ? 'bg-emerald-500 border-emerald-500 text-white' : ($step2_active ? 'bg-white border-blue-500 text-blue-500 scale-110 shadow-lg shadow-blue-500/20' : 'bg-white border-slate-200 text-slate-300')); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step2_done): ?>
                                            <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>
                                        <?php else: ?>
                                            <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="pl-4">
                                        <div class="flex items-center justify-between gap-4 flex-wrap">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->paid_at): ?>
                                                <span class="text-[10px] font-semibold text-slate-400 font-mono"><?php echo e($order->paid_at->format('d M Y, H:i')); ?> WIB</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <p class="text-xs text-slate-500 mt-1 leading-relaxed">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step2_done): ?>
                                                Roster beton pesanan Anda telah dicetak, diperiksa kualitasnya, dan siap dikirim.
                                            <?php elseif($step2_active): ?>
                                ...
                                <div class="relative">
                                    <!-- Indicator Node -->
                                    <div class="absolute -left-[37px] top-0.5 w-6 h-6 rounded-full flex items-center justify-center border-2 transition-all duration-300
                                        <?php echo e($step3_done ? 'bg-emerald-500 border-emerald-500 text-white' : ($step3_active ? 'bg-white border-purple-500 text-purple-500 scale-110 shadow-lg shadow-purple-500/20' : 'bg-white border-slate-200 text-slate-300')); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step3_done): ?>
                                            <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>
                                        <?php else: ?>
                                            <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="pl-4">
                                        <div class="flex items-center justify-between gap-4 flex-wrap">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->shipped_at): ?>
                                                <span class="text-[10px] font-semibold text-slate-400 font-mono"><?php echo e($order->shipped_at->format('d M Y, H:i')); ?> WIB</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <p class="text-xs text-slate-500 mt-1 leading-relaxed">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step3_done): ?>
                                                Pesanan telah dibawa dan dikirim menuju lokasi Anda oleh driver/kurir: <strong><?php echo e($order->courier ?? 'Armada Pabrik'); ?></strong>.

                                            <?php elseif($step3_active): ?>
                                ...
                                <div class="relative">
                                    <!-- Indicator Node -->
                                    <div class="absolute -left-[37px] top-0.5 w-6 h-6 rounded-full flex items-center justify-center border-2 transition-all duration-300
                                        <?php echo e($step4_done ? 'bg-emerald-500 border-emerald-500 text-white' : ($status === 'completed' || $status === 'delivered' ? 'bg-white border-emerald-500 text-emerald-500 scale-110 shadow-lg shadow-emerald-500/20' : 'bg-white border-slate-200 text-slate-300')); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step4_done): ?>
                                            <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>
                                        <?php else: ?>
                                            <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="pl-4">
                                        <div class="flex items-center justify-between gap-4 flex-wrap">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->completed_at): ?>
                                                <span class="text-[10px] font-semibold text-slate-400 font-mono"><?php echo e($order->completed_at->format('d M Y, H:i')); ?> WIB</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <p class="text-xs text-slate-500 mt-1 leading-relaxed">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step4_done): ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step4_done && $order->delivery_photo_path): ?>
                                            <div class="mt-4 p-2.5 bg-slate-50 border border-slate-100 rounded-xl inline-block max-w-sm">
                                                ...
                                                <img src="<?php echo e(url('storage/' . $order->delivery_photo_path)); ?>" alt="Bukti Pengiriman" class="rounded-lg w-full h-auto object-cover shadow-sm">
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
                            ...
                            <div class="text-xs space-y-2">
                                <p class="font-bold text-slate-800 text-sm"><?php echo e($order->shipping_name); ?></p>
                                <p class="text-slate-500 font-semibold"><?php echo e($order->shipping_phone); ?></p>
                                <p class="text-slate-600 leading-relaxed"><?php echo e($order->shipping_address); ?>, <?php echo e($order->shipping_city); ?>, <?php echo e($order->shipping_province); ?> <?php echo e($order->shipping_postal_code); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="py-3 first:pt-0 last:pb-0 flex items-start gap-3">
                                        ...
                                        <div class="w-12 h-12 bg-slate-100 rounded-lg shrink-0 overflow-hidden flex items-center justify-center border border-slate-200/50">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->product && $item->product->primary_image): ?>
                                                <img src="<?php echo e($item->product->primary_image); ?>" alt="<?php echo e($item->product_name); ?>" class="w-full h-full object-cover">
                                            <?php else: ?>
                                        ...
                                        <div class="flex-1 min-w-0 text-xs">
                                            <p class="font-bold text-slate-800 leading-tight truncate"><?php echo e($item->product_name); ?></p>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->product_variant_name): ?>
                                                <p class="text-slate-400 mt-0.5">Varian: <?php echo e($item->product_variant_name); ?></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <p class="text-slate-500 mt-1">Jumlah: <?php echo e($item->quantity); ?> pcs</p>
                                        </div>
                                        <span class="text-xs font-bold text-slate-800 whitespace-nowrap">Rp<?php echo e(number_format($item->subtotal, 0, ',', '.')); ?></span>
                                    </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status === 'pending_payment' && $order->payment_status !== 'paid'): ?>
                                <div class="mt-4 pt-4 border-t border-slate-100">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isExpired): ?>
                                        ...
                                        <p class="text-[10px] text-center text-slate-400 mt-2">Batas waktu: <?php echo e($order->created_at->addDay()->format('d M Y, H:i')); ?></p>
                                    <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->invoice): ?>
                                <div class="mt-4 pt-4 border-t border-slate-100">
                                    <a href="<?php echo e(URL::signedRoute('print.invoice', ['invoice' => $order->invoice->id])); ?>" target="_blank" class="w-full inline-flex items-center justify-center bg-slate-900 hover:bg-black text-white text-xs font-bold px-4 py-2.5 rounded-xl shadow-sm transition-all gap-1.5 cursor-pointer">
                                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<?php /**PATH C:\xampp\htdocs\indoroster\resources\views/livewire/order-tracking.blade.php ENDPATH**/ ?>