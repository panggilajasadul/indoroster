    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <nav class="flex text-xs font-semibold text-slate-400 gap-1.5 mb-2 uppercase tracking-wider">
                <a href="<?php echo e(route('home')); ?>" class="hover:text-slate-600 transition-colors">Home</a>
                <span>/</span>
        ...
        <div class="bg-white border border-slate-100 rounded-2xl p-1.5 shadow-sm mb-6 flex overflow-x-auto scrollbar-none gap-1">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                ...
                <button wire:click="setTab('<?php echo e($key); ?>')" 
                    ...
                    <?php echo e($activeTab === $key ? 'bg-terra-500 text-white shadow-md shadow-terra-500/25' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50'); ?>">
                    <?php echo e($label); ?>
        ...
        <div class="space-y-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($orders) === 0): ?>
                <div class="bg-white border border-slate-100 rounded-2xl shadow-sm p-16 text-center">
                    ...
                    <a href="<?php echo e(route('catalog')); ?>" class="font-display inline-flex items-center justify-center bg-slate-900 hover:bg-black text-white font-bold px-6 py-3 rounded-xl transition-all duration-200 mt-6 gap-2 text-sm">
                        Belanja Sekarang
                    </a>
                </div>
            <?php else: ?>
                    ...
                    <div class="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden transition-all duration-200 hover:shadow-md">
                        ...
                        <div class="bg-slate-50/50 px-6 py-4 border-b border-slate-100 flex flex-wrap justify-between items-center gap-3">
                            <div class="flex items-center gap-3 flex-wrap">
                                <span class="font-display font-black text-sm text-slate-900"><?php echo e($order->order_number); ?></span>
                                <span class="text-slate-300">|</span>
                                <span class="text-xs text-slate-500 font-semibold"><?php echo e($order->created_at->format('d M Y, H:i')); ?> WIB</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                ?>
                                <span class="font-display font-bold text-[10px] px-3 py-1 rounded-full border uppercase tracking-wider <?php echo e($statusColors); ?>">
                                ...
                                <div class="py-4 first:pt-0 last:pb-0 flex gap-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->product_variant_name): ?>
                                            <p class="text-xs text-slate-500 mt-0.5">Varian: <?php echo e($item->product_variant_name); ?></p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <p class="text-xs text-slate-400 mt-1">Jumlah: <?php echo e($item->quantity); ?> pcs</p>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-xs text-slate-400 font-medium">Rp<?php echo e(number_format($item->product_price, 0, ',', '.')); ?></div>
                                        <div class="text-sm font-bold text-slate-800 mt-0.5">Rp<?php echo e(number_format($item->subtotal, 0, ',', '.')); ?></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        <div class="bg-slate-50/30 border-t border-slate-100 p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            ...
                            <div class="flex-1">
                                    ...
                                    <div class="bg-white border border-slate-100 rounded-xl p-3.5 flex gap-3 text-slate-700 shadow-sm max-w-md">
                                        ...
                                        <div class="text-xs leading-normal">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->courier): ?>
                                                <p class="text-slate-600 mt-0.5">Sopir: <strong><?php echo e($order->courier); ?></strong></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->tracking_number): ?>
                                                <p class="text-slate-500">Plat Truk: <span class="bg-slate-100 text-slate-800 px-1.5 py-0.5 rounded font-mono font-bold text-[10px]"><?php echo e($order->tracking_number); ?></span></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->courier_phone): ?>
                                                <div class="mt-2">
                                                    ...
                                                    ?>
                                                    <a href="https://wa.me/<?php echo e($waPhone); ?>?text=<?php echo e($waText); ?>" target="_blank" class="inline-flex items-center gap-1 font-bold text-emerald-600 hover:text-emerald-700 transition-colors">
                                ...
                                <?php else: ?>
                                    <div class="text-xs text-slate-500 max-w-sm leading-relaxed">
                                        Status: <strong><?php echo e($order->status_label); ?></strong>. 
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status === 'pending_payment'): ?>
                            ...
                            <div class="flex flex-col items-end gap-2 shrink-0">
                                <div class="text-right">
                                    ...
                                    <div class="font-display font-black text-terra-600 text-lg">Rp<?php echo e(number_format($order->grand_total, 0, ',', '.')); ?></div>
                                </div>
                                
                                <div class="flex gap-2.5">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status === 'pending_payment' && $order->payment_status === 'unpaid'): ?>
                                        <button wire:click="payOrder(<?php echo e($order->id); ?>)" class="font-display inline-flex items-center justify-center bg-slate-900 hover:bg-black text-white text-xs font-bold px-4 py-2.5 rounded-xl shadow-sm transition-all gap-1.5 cursor-pointer">
                                    ...
                                    <a href="<?php echo e(route('order.tracking', ['order_number' => $order->order_number, 'contact' => $order->shipping_email ?? $order->shipping_phone])); ?>" class="inline-flex items-center justify-center bg-terra-50 text-terra-600 hover:bg-terra-100 hover:text-terra-700 text-xs font-bold px-4 py-2.5 rounded-xl shadow-xs transition-all gap-1.5">
                                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->invoice): ?>
                                        <a href="<?php echo e(URL::signedRoute('print.invoice', ['invoice' => $order->invoice->id])); ?>" target="_blank" class="inline-flex items-center justify-center border border-slate-200 hover:bg-slate-50 text-slate-700 text-xs font-bold px-4 py-2.5 rounded-xl shadow-xs transition-all gap-1.5">
                                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<?php /**PATH C:\xampp\htdocs\indoroster\resources\views/livewire/member/order-history.blade.php ENDPATH**/ ?>